...
async function fetchData() {
  try {
    ...
    function f1() {
      ...
      console.log(item);
      window.location.href = `/third?item=${item}`;
    }
    function f2() {
    ...
    document.getElementById("cal1").innerHTML =
      "Calories: " +
      response.data.hints[0].food.nutrients.ENERC_KCAL.toFixed(2) +
      "kcal";
    document.getElementById("prot1").innerHTML =
      "Proteins: " +
      response.data.hints[0].food.nutrients.PROCNT.toFixed(2) +
      "g";
    ...
    document
      .getElementsByClassName("rect")[0]
      .addEventListener("click", (e) => {
        f1();
      });

    document
      .getElementsByClassName("rect")[1]
      .addEventListener("click", (e) => {
        f2();
      });
    document
      .getElementsByClassName("rect")[2]
      .addEventListener("click", (e) => {
        f3();
      });
    document
      .getElementsByClassName("rect")[3]
      .addEventListener("click", (e) => {
        f4();
      });
    document
      .getElementsByClassName("rect")[4]
      .addEventListener("click", (e) => {
        f5();
      });
    document
      .getElementsByClassName("rect")[5]
      .addEventListener("click", (e) => {
        f6();
      });
    document
      .getElementsByClassName("rect")[6]
      .addEventListener("click", (e) => {
        f7();
      });
    document
      .getElementsByClassName("rect")[7]
      .addEventListener("click", (e) => {
        f8();
      });
    if (response.data.hints[0].food.nutrients.FIBTG == undefined) {
      document.getElementById("fibre1").innerHTML = "Fibre: " + "-";
    } else {
      document.getElementById("fibre1").innerHTML =
        "Fibre: " +
        response.data.hints[0].food.nutrients.FIBTG.toFixed(2) +
        "g";
    }

    //item2
    document.getElementById("item2").innerHTML =
      response.data.hints[1].food.label;
    document.getElementById("cal2").innerHTML =
      "Calories: " +
      response.data.hints[1].food.nutrients.ENERC_KCAL.toFixed(2) +
      "kcal";
    document.getElementById("prot2").innerHTML =
      "Proteins: " +
      response.data.hints[1].food.nutrients.PROCNT.toFixed(2) +
      "g";
    ...
    if (response.data.hints[1].food.nutrients.FIBTG == undefined) {
      document.getElementById("fibre2").innerHTML = "Fibre: " + "-";
    } else {
      document.getElementById("fibre2").innerHTML =
        "Fibre: " +
        response.data.hints[1].food.nutrients.FIBTG.toFixed(2) +
        "g";
    }

    //item3
    document.getElementById("item3").innerHTML =
      response.data.hints[2].food.label;
    document.getElementById("cal3").innerHTML =
      "Calories: " +
      response.data.hints[2].food.nutrients.ENERC_KCAL.toFixed(2) +
      "kcal";
    document.getElementById("prot3").innerHTML =
      "Proteins: " +
      response.data.hints[2].food.nutrients.PROCNT.toFixed(2) +
      "g";
    ...
    if (response.data.hints[2].food.nutrients.FIBTG == undefined) {
      document.getElementById("fibre3").innerHTML = "Fibre: " + "-";
    } else {
      document.getElementById("fibre3").innerHTML =
        "Fibre: " +
        response.data.hints[2].food.nutrients.FIBTG.toFixed(2) +
        "g";
    }

    //item4
    document.getElementById("item4").innerHTML =
      response.data.hints[3].food.label;
    document.getElementById("cal4").innerHTML =
      "Calories: " +
      response.data.hints[3].food.nutrients.ENERC_KCAL.toFixed(2) +
      "kcal";
    document.getElementById("prot4").innerHTML =
      "Proteins: " +
      response.data.hints[3].food.nutrients.PROCNT.toFixed(2) +
      "g";
    ...
    if (response.data.hints[3].food.nutrients.FIBTG == undefined) {
      document.getElementById("fibre4").innerHTML = "Fibre: " + "-";
    } else {
      document.getElementById("fibre4").innerHTML =
        "Fibre: " +
        response.data.hints[3].food.nutrients.FIBTG.toFixed(2) +
        "g";
    }

    //item5
    document.getElementById("item5").innerHTML =
      response.data.hints[4].food.label;
    document.getElementById("cal5").innerHTML =
      "Calories: " +
      response.data.hints[4].food.nutrients.ENERC_KCAL.toFixed(2) +
      "kcal";
    document.getElementById("prot5").innerHTML =
      "Proteins: " +
      response.data.hints[4].food.nutrients.PROCNT.toFixed(2) +
      "g";
    ...
    if (response.data.hints[4].food.nutrients.FIBTG == undefined) {
      document.getElementById("fibre5").innerHTML = "Fibre: " + "-";
    } else {
      document.getElementById("fibre5").innerHTML =
        "Fibre: " +
        response.data.hints[4].food.nutrients.FIBTG.toFixed(2) +
        "g";
    }

    //item6
    document.getElementById("item6").innerHTML =
      response.data.hints[5].food.label;
    document.getElementById("cal6").innerHTML =
      "Calories: " +
      response.data.hints[5].food.nutrients.ENERC_KCAL.toFixed(2) +
      "kcal";
    document.getElementById("prot6").innerHTML =
      "Proteins: " +
      response.data.hints[5].food.nutrients.PROCNT.toFixed(2) +
      "g";
    ...
    if (response.data.hints[5].food.nutrients.FIBTG == undefined) {
      document.getElementById("fibre6").innerHTML = "Fibre: " + "-";
    } else {
      document.getElementById("fibre6").innerHTML =
        "Fibre: " +
        response.data.hints[5].food.nutrients.FIBTG.toFixed(2) +
        "g";
    }

    //item7
    document.getElementById("item7").innerHTML =
      response.data.hints[6].food.label;
    document.getElementById("cal7").innerHTML =
      "Calories: " +
      response.data.hints[6].food.nutrients.ENERC_KCAL.toFixed(2) +
      "kcal";
    document.getElementById("prot7").innerHTML =
      "Proteins: " +
      response.data.hints[6].food.nutrients.PROCNT.toFixed(2) +
      "g";
    ...
    if (response.data.hints[6].food.nutrients.FIBTG == undefined) {
      document.getElementById("fibre7").innerHTML = "Fibre: " + "-";
    } else {
      document.getElementById("fibre7").innerHTML =
        "Fibre: " +
        response.data.hints[6].food.nutrients.FIBTG.toFixed(2) +
        "g";
    }

    //item8
    document.getElementById("item8").innerHTML =
      response.data.hints[7].food.label;
    document.getElementById("cal8").innerHTML =
      "Calories: " +
      response.data.hints[7].food.nutrients.ENERC_KCAL.toFixed(2) +
      "kcal";
    document.getElementById("prot8").innerHTML =
      "Proteins: " +
      response.data.hints[7].food.nutrients.PROCNT.toFixed(2) +
      "g";
    ...
    if (response.data.hints[7].food.nutrients.FIBTG == undefined) {
      document.getElementById("fibre8").innerHTML = "Fibre: " + "-";
    } else {
      document.getElementById("fibre8").innerHTML =
        "Fibre: " +
        response.data.hints[7].food.nutrients.FIBTG.toFixed(2) +
        "g";
    }

    document
      .getElementById("search")
      .getElementsByTagName("p")[0].innerHTML = ite;
  } catch (error) {
    console.error(error);
  }
}
